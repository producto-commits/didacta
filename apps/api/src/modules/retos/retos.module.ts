...
/// Fase C: entregas de capturas validadas por IA de visión ("Reportar un reto").
...
@Module({
  ...
  providers: [RetosService, RetosEngineService, RetosEventsBridge, RetosSubmissionsService],
